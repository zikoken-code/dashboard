...
# =============================================================================
# STYLES CSS PERSONNALISÉS (thème sombre)
# =============================================================================
st.markdown("""
<style>
...
# Couleur et fond du badge de criticité sur les cartes de maintenance
CRIT_STYLE = {
...
def gauge_fig(value, title, max_val, unit, thresholds):
    """
    Crée une jauge Plotly colorée selon des seuils.
...
# =============================================================================
# FONCTIONS UTILITAIRES — PLAN DE MAINTENANCE
# =============================================================================
...
def afficher_section_periode(cle, pm_filtre):
    ...
    en-tête avec icône et nombre d'opérations, puis grille de 4 cartes par ligne.
    """
    ...
    # Grille CSS à 4 colonnes rendue via components.html
    cards_html = ""
...
def afficher_tab1(données, kpis, sel_machines):
    ...
    # ── Analyse temporelle & équipements ─────────────────────────────────────
...
def afficher_tab2(données, amdec_machines, amdec_composants):
    ...
    # ── Pareto — Temps d'arrêt par machine ───────────────────────────────────
